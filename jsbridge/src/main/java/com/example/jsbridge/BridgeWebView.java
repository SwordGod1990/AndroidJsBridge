...
//        mContent.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    ...
    public void sendToWeb(String function, Object... values) {
        ...
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            ...
            jsCommand = String.format(com.github.lzyzsd.jsbridge.BridgeUtil.JAVASCRIPT_STR, jsCommand);
            loadUrl(jsCommand);
        }
    }
    ...
    private void doSend(String handlerName, Object data, OnBridgeCallback responseCallback) {
        ...
        if (responseCallback != null) {
            String callbackId = String.format(com.example.jsbridge.BridgeUtil.CALLBACK_ID_FORMAT, (++mUniqueId) + (com.example.jsbridge.BridgeUtil.UNDERLINE_STR + SystemClock.currentThreadTimeMillis()));
